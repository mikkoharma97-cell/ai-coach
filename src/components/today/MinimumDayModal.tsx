  ...
  return (
    ...
    >
      <div
        ...
        className="max-h-[min(88vh,90dvh)] w-full max-w-md overflow-y-auto overscroll-contain rounded-t-[var(--radius-2xl)] border border-white/[0.12] bg-[var(--background)] p-5 shadow-[0_24px_80px_rgba(0,0,0,0.55)] lg:max-h-[min(90vh,36rem)] lg:rounded-[var(--radius-xl)] [-webkit-overflow-scrolling:touch]"
      >
        {step === "intro" && !active ? (
          <>
            <h2
