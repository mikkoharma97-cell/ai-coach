...
export const coachVoice = {
  ...
  rules: [
    ...
    "Vältä pehmeää ehdollista (halutessasi, suosittelemme, tarkastele) — käytä: Aloita, Tee tämä, Näin teet.",
    "Myynti: kipu → seuraava askel, kiire ilman huutoa, luottamus ilman hypeä (HÄRMÄ15).",
